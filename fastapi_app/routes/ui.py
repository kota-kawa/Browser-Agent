...
def index(request: Request) -> Response:
	...
	return templates.TemplateResponse(request=request, name='index.html', context={'browser_url': _BROWSER_URL})
...
def agent_result(request: Request) -> Response:
	...
	return templates.TemplateResponse(request=request, name='agent_result.html', context={'browser_url': _BROWSER_URL})
